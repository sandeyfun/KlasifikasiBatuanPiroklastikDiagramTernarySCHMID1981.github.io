...
if st.button("Classify & Plot Diagram"):
    ...
    if total == 0:
        ...
        # --- TAMBAHAN LABEL DI DALAM SEGITIGA ---
        ax.text(50, 72.2, "Bombs and Blocks", fontsize=9, color="gray", ha='center', va='center')
        ax.text(50, 43.3, "Tuff Breccia", fontsize=9, color="gray", ha='center', va='center')
        ax.text(50, 10.8, "Lapilli Tuff", fontsize=9, color="gray", ha='center', va='center')
        ax.text(12.5, 7.2, "Lapilli", fontsize=9, color="gray", ha='center', va='center', rotation=60)
        ax.text(87.5, 7.2, "Tuff/Ash Tuff", fontsize=9, color="gray", ha='center', va='center', rotation=-60)
        # ----------------------------------------
